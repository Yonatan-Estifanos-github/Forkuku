...
export const JOURNEY_DATA: JourneyItem[] = [
  {
    ...
    amDescription:
      '[Saron] 2021 መጀመሪያ ወራቶች የኮቪድ ዘመን ከቤት መዉጣት በመከልከሉ ምክንያት መንፈሳዊ ፕሮግራሞችም ወደ ዙም ሚቲንግ ተቀየሩ። ታላቁ ፈላስፋ ከበደ ሚካኤል \'በረከተ መርገም\' (bitter sweet) ብለዉ እንደገለፁት ክፉዉ የኮቪድ ዘመንም እኔና ዮኒ በዙም የፀሎት ፕሮግራም ላይ የተገናኘንበትን መልካም እድልን ከፈተ። ሜሪላንድ እና ፔንሲልቫኒያ በየቤታችን ሆነን እየተካፈልን በሄድንና ቀናት በጨመሩ ቁጥር ከጉባዔዉ መካከል የአንድ ሰዉ የፀሎት ስታይል ልቤን እየሰረቀዉ መጣ። ለካስ በዚያም በኩል ተመሳሳይ ስሜት ተፈጥሮ ነበርና አንድ ቀን የኢንስታግራም ጓደኝነት ጥያቄ ደረሰኝ። ዮኒ ነበር። ሃሌሉያ!! ጓደኝነት ተጀመረ። ሀሪስበርግ ፔንሲልቫኒያ መመላለስ ኒዉ ኖርማል ሆነ። ለዚህ ቅርቡ ታይትል የጋብርኤል ጋርሲያ \'Love in the time of cholera\' የሚለዉ ነዉ:: (Watch: ሙሉ ታሪኩን ሳይሆን the devotion despite disease and distance)::',
  },
  {
    id: 2,
    year: 'Late 2021',
