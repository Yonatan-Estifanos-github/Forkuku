...
export const JOURNEY_DATA: JourneyItem[] = [
  {
    ...
    amDescription:
      '[Saron] የኮቪድ ዘመን ከቤት መዉጣት በመከልከሉ ምክንያት መንፈሳዊ ፕሮግራሞችም ወደ ዙም ሚቲንግ ተቀየሩ። ታላቁ ፈላስፋ ከበደ ሚካኤል \'በረከተ መርገም\' ብለዉ እንደገለፁት ክፉዉ የኮቪድ ዘመንም እኔና ዮኒ በዙም የፀሎት ፕሮግራም ላይ የተገናኘንበትን መልካም እድልን ከፈተ። ሜሪላንድ እና ፔንሲልቫኒያ በየቤታችን ሆነን እየተካፈልን በሄድንና ቀናት በጨመሩ ቁጥር ከጉባዔዉ መካከል የአንድ ሰዉ የፀሎት ስታይል ልቤን እየሰረቀዉ መጣ። ለካስ በዚያም በኩል ተመሳሳይ ስሜት ተፈጥሮ ነበርና አንድ ቀን የኢንስታግራም ጓደኝነት ጥያቄ ደረሰኝ። ዮኒ ነበር። ሃሌሉያ!! ጓደኝነት ተጀመረ። ሀሪስበርግ ፔንሲልቫኒያ መመላለስ ኒዉ ኖርማል ሆነ። ለዚህ ቅርቡ ታይትል የጋብርኤል ጋርሲያ \'ፍቅር በኮሌራ ዘመን\' የሚለዉ ነዉ።',
    },  {
    id: 2,
    year: 'Late 2021',
