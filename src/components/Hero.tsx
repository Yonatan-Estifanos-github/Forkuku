...
const SCENE_THEMES: Record<'dark' | 'light', SceneTheme> = {
  ...
  light: {
    ...
    ambientColor: '#FFFFFF',
    lights: [
      { kind: 'point', position: [12, 12, 8], intensity: 0.9, color: '#FFFFFF' },
      { kind: 'point', position: [-12, 6, 8], intensity: 0.6, color: '#E7EFEA' },
      { kind: 'point', position: [0, -8, 10], intensity: 0.3, color: '#FAFAFA' },
      { kind: 'spot', position: [0, 18, 12], intensity: 0.6, color: '#FFFFFF', angle: 0.45, penumbra: 1 },
      { kind: 'spot', position: [-8, 8, 10], intensity: 0.3, color: '#D8E3DC', angle: 0.5, penumbra: 0.9 },
    ],
    fireflyColor: '#C5A059',
    glowColor: '#C5A059',
